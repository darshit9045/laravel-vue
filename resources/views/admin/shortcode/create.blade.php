...
@section('title', 'Add New Shortcode')
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2 class="font-weight-bold border-bottom pb-3 pt-3">Add New Shortcode</h2>
            </div>
    ...
    <form action="{{ route('custom-shortcode.store') }}" method="POST" id="myForm" onsubmit="return submitForm()">
        @csrf
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="value" class="form-control mt-2" placeholder="value" value="{{ old('value') }}">
                </div>
            </div>
