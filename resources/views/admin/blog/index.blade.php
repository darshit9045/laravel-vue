...
@section('content_header')
    <h1 class="font-weight-bold border-bottom pb-3 d-flex align-items-center justify-content-between">Blogs <a class="btn btn-info btn-sm" href="{{ route('blog.create') }}"><i class="fa fa-plus pr-1" aria-hidden="true"></i>Add Blog</a></h1>
@stop
            ...
            @forelse ($blogs as $blog)
                <tr>
                    ...
                    <td class="d-flex">
                        ...
                        @else
                            <a class="btn btn-info mr-2" href="{{ route('blog.show',$blog->id) }}">
                            ...
                            <a class="btn btn-primary mr-2" href="{{ route('blog.edit',$blog->id) }}">
